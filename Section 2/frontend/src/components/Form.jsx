...
function Form() {
  ...
  const handleSubmit = (e) => {
    if (!inputFirstName.trim() || !inputEmail.trim() || !password.trim() || !confirmPassword.trim()) {
      Swal.fire({
        icon: "error",
        title: "Caution",
    ...
    if (inputFirstName.length <= 3 || inputFirstName.length >= 30) {
      Swal.fire({
        icon: "error",
        title: "Caution",
        text: "First Name characters should be b/w 3 & 30",
        showConfirmButton: true,
        timer: 3000,
      });
      return;
    ...
    if (password !== confirmPassword) {
      ...
      Swal.fire({
        icon: "error",
        title: "Caution",
        text: "Password & Confirm Password is Not Same",
        showConfirmButton: true,
        timer: 3000,
      });
      return;
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="col-span-2 grid grid-cols-2">
            ...
            <div className="mb-4 py-[5%]">
              <h2 className="text-left font-bold text-2xl">Sign Up</h2>
            </div>
          </div>
