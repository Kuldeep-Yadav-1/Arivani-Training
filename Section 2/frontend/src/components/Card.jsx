...
function Card() {
  ...
  return (
    <>
      <div className="shadow-2xl w-96 px-2 py-4 m-5 rounded min-w-min">
        <div className="flex ">
          <span className="m-2">
            <img
        ...
        <div className="grid grid-cols-3 gap-4 m-auto">
          ...
          <div className="mx-auto">
            ...
            <div className="my-auto">
              <button className="bg-gray-700 px-5 py-2 rounded-lg text-white mt-1 cursor-pointer"
          ...
          <div className="mx-auto">
            ...
            <div className="my-auto">
              <button className="bg-gray-700 px-5 py-2 rounded-lg text-white cursor-pointer"
